...
var infoStream = fs.createWriteStream("logs/info.txt", { encoding : 'utf-8' });
...
// file if needed.
var errorStream = fs.createWriteStream("logs/error.txt", { encoding : 'utf-8' });
...
var debugStream = fs.createWriteStream("logs/debug.txt", { encoding : 'utf-8' });
